...
///*****                                                         *****///
/////////////////////////////////////////////////////////////////////////
Servos servos0(0x40);          // Dome Door Panels (Decimal 66)(TEMPORARILY USING 0x40, but NEED TO SWITCH BACK to 0x42)
...
//                       { 0,1217,1971,0,0,-1,-1},   // Little Door by front HP - Pos 1
                     { 0,475,300,0,0,-1,-1},   // Little Door by front HP - Pos 1
                     { 1,475,300,1,0,-1,-1},   // Little Door by front HP   Pos 2
                     { 2,473,305,0,0,-1,-1},   // Little Door by front HP   Pos 3
                     { 3,460,295,1,0,-1,-1},   // Medium Door by front HP
                     { 4,470,320,0,0,-1,-1},   // Medium unpainted door by Magic Panel
                     { 5,460,300,1,0,-1,-1},   // Large Door by rear Logic
...
//   Wire.onReceive(i2cEvent);                                                             // register event so when we receive something we jump to receiveEvent();
 ...
 bool success = Wire.begin(SDA_PIN, SCL_PIN, I2C_SLAVE_ADDR);
    if (!success) {
