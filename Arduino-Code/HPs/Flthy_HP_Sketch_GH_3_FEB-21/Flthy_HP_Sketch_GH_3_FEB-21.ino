...
///*****                                                                  *****///
//////////////////////////////////////////////////////////////////////////////////
const int HPpos[HPCOUNT][HPPOSITIONS][2] = {{{2330,1670},   // Front HP Down
                                             {1860,1670},   // Front HP Center
                                             {1560,1670},   // Front HP Up
                                             {1860,2150},   // Front HP Left
                                             {1390,1840},   // Front HP Upper Left
                                             {2175,2050},   // Front HP Lower Left
                                             {1860,1200},   // Front HP Right
                                             {1390,1200},   // Front HP Upper Right
                                             {2210,1200}},  // Front HP Lower Right
                                            {{1422,1623},  // Rear HP Down
                                             {1841,1626},   // Rear HP Center
                                             {2500,1437},   // Rear HP Up
                                             {1724,2238},   // Rear HP Left
                                             {2500,1437},   // Rear HP Upper Left
                                             {1558,1946},   // Rear HP Lower Left
                                             {1841,1200},   // Rear HP Right
                                             {2167,1267},   // Rear HP Upper Right
                                             {1427,1267}},  // Rear HP Lower Right
                                            {{2200,1550},   // Top HP Down
                                             {1560,1520},   // Top HP Center
                                             {972,1550},   // Top HP Up
                                             {1560,2180},   // Top HP Left
                                             {1230,2180},   // Top HP Upper Left
                                             {1980,2180},   // Top HP Lower Left
                                             {1560,930},   // Top HP Right
                                             {1460,830},   // Top HP Upper Right
                                             {2100,1040}}}; // Top HP Lower right
...
const int dimPulseSpeedRange[2] = {10, 40};     // Range used to map to value options 0-9, Lower is faster.
...
//
const uint32_t basicColors[11][10] = {{     C_OFF,     C_OFF,     C_OFF,    C_OFF,    C_OFF,     C_OFF,    C_OFF,   C_OFF, C_OFF, C_OFF},    // Off
                                      ...
                                      {     C_RED,  C_YELLOW,   C_GREEN,   C_CYAN,   C_BLUE, C_MAGENTA, C_PURPLE, C_WHITE, C_OFF, C_OFF}};   // Random
...
void loop(){
  ...
  for(int i=0; i<HPCOUNT; i++) {
    switch (LED_command[i].LEDFunction) {
      ...
      case 7: dimPulse(i, LED_command[i].LEDOption1, LED_command[i].LEDOption2); break;
      case 4: cycle(i,LED_command[i].LEDOption1); break;
      case 14: ShortCircuit(i,LED_command[i].LEDOption1); break;
      case 15: ledColor(i,LED_command[i].LEDOption1);flushCommandArray(i,0); break;
      case 5: rainbow(i); break;
...
void dimPulse(byte hp, int c, int setting) {
  int inter = map(setting, 0, 9, dimPulseSpeedRange[0], dimPulseSpeedRange[1]); //changed 3 from 9
  long elapsed;
  int frames;
  if ((millis() - tCounter[hp]) > interval[hp]) {
