...
const int HPpos[HPCOUNT][HPPOSITIONS][2] = {{{2330,1670},   // Front HP Down
                                             ...
                                             {1860,1200},   // Front HP Left
                                             {1390,1200},   // Front HP Upper Left
                                             {2210,1200},   // Front HP Lower Left
                                             {1860,2150},   // Front HP Right
                                             {1390,1840},   // Front HP Upper Right
                                             {2175,2050}},  // Front HP Lower Right
                                            {{2500,1437},  // Rear HP Down
                                             {1841,1626},   // Rear HP Center
                                             {1422,1623},   // Rear HP Up
                                             {1841,1200},   // Rear HP Left
                                             {1427,1267},   // Rear HP Upper Left
                                             {2167,1267},   // Rear HP Lower Left
                                             {1730,2240},   // Rear HP Right
                                             {1560,1946},   // Rear HP Upper Right
                                             {2500,1437}},  // Rear HP Lower Right
                                            {{972,1550},   // Top HP Down
                                             {1560,1520},   // Top HP Center
                                             {2200,1550},   // Top HP Up
                                             {1560,2180},   // Top HP Left
                                             {1980,2180},   // Top HP Upper Left
                                             {1230,2180},   // Top HP Lower Left
                                             {1560,930},   // Top HP Right
                                             {2100,1040},   // Top HP Upper Right
                                             {1460,830}}}; // Top HP Lower right
