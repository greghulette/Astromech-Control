...
function getcheckedElementsforBodyController(l, m, c, v) {
  console.log("LDP: " + l);
  console.log("Maint: " + m);
  console.log("Coin: " + c);
  console.log("VU: " + v);
  ...
  else if (l == true & m == true & c == false & v == false) { return "T"; }
  else if (l == false & m == true & c == true & v == false) { return "U"; }
  else if (l == false & m == true & c == false & v == true) { return "W"; }
  else if (l == true & m == false & c == true & v == true) { return "F"; }

}

function getcheckedElementsforHPController(f, t, r) {
  ...
  if (f == true & t == false & r == false) { return "F"; }
...
function commandStripOffRainbow(u) {
  ...
  let commandtoSendtoHPController = '&param1=' + checkHP + '98';
  ...
  // if (coincommandstring != undefined) { var coinCommandParam = "&param3=" + BLCommandPrefix + coincommandstring; } else { var coinCommandParam = "" };
  // if (vucommandstring != undefined) { var vuCommandParam = "&param4=" + BLCommandPrefix + vucommandstring; } else { var vuCommandParam = "" };
  // let fullURL = ldpCommandParam + maintCommandParam + coinCommandParam + BLCommandPrefix + vuCommandParam;
  // bodyControllerLEDFunctionExecution(fullURL);
...
function commandNoOptionsRainbow(y, t, u) {
  ...
  var checkHP = getcheckedElementsforHPController(hpfcommandstring, hptcommandstring, hprcommandstring);
  let commandtoSendtoHPController = '&param1=' + checkHP + y;
  setTimeout(function () { HPLEDFunctionExecution(commandtoSendtoHPController) }, delaySecondHTTPGet);
};
...
function commandSingleColorSolidColor(y, t, z, u) {
  ...
  var checkHP = getcheckedElementsforHPController(hpfcommandstring, hptcommandstring, hprcommandstring);
  let commandtoSendtoHPController = '&param1=' + checkHP + y + colorValues;
  setTimeout(function () { HPLEDFunctionExecution(commandtoSendtoHPController) }, delaySecondHTTPGet);
...
function commandStripOffDimPulse2(u) {
  var checkmark = document.getElementById(u)
  checkmark.classList.remove('hidden');
  setTimeout(function () { checkmark.classList.add('hidden') }, 2000);
  // document.getElementById(u).src = "Images/checkmark.png";
...
function commandStripOffDimPulse3(u) {
  var checkmark = document.getElementById(u)
  checkmark.classList.remove('hidden');
  setTimeout(function () { checkmark.classList.add('hidden') }, 2000);
  // document.getElementById(u).src = "Images/checkmark.png";
...
function commandStripOffDualBounce(u) {
  var checkmark = document.getElementById(u)
  checkmark.classList.remove('hidden');
  setTimeout(function () { checkmark.classList.add('hidden') }, 2000);
  for (var i = 0; i < checkedItemsDualBounce.length; i++) {
...
function commandTwoColorsNoSliderShortCircuit(y, t, z, s, u) {
  ...
  let fullBodyControllerURL = ldpCommandParam + maintCommandParam + coinCommandParam + vuCommandParam;
  bodyControllerLEDFunctionExecution(fullBodyControllerURL);
  if (hpfcommandstring != undefined) { var hpFrontParam = "&param5=NHP" + HPCommandPrefix + hpfcommandstring; } else { var hpFrontParam = "" };
  if (hptcommandstring != undefined) { var hpTopParam = "&param6=NHP" + HPCommandPrefix + hptcommandstring; } else { var hpTopParam = "" };
  if (hprcommandstring != undefined) { var hpRearParam = "&param7=NHP" + HPCommandPrefix + hprcommandstring; } else { var hpRearParam = "" };
  let fullHPLEDControllerURL = hpFrontParam + hpTopParam + hpRearParam
  HPLEDFunctionExecution(fullHPLEDControllerURL);
